<?php 
$subtitle="Your System support partner";
include('header.php');
...
if(isset($_POST['action']) && $_POST['action']=='Submit'){
	...
	if ($error===false) {
		...
		// see: https://github.com/sendgrid/sendgrid-php/releases
...
function ValidateForm()
{
	...
	<form class="form-horizontal" name=form method="post" action="getsupport.php">
	  ...
	  You wish to pay:
	  <label for="weekly"> <input type="radio" id="weekly"  name="schedule" value="weekly" > Weekly</label>
	  <label for="monthly"><input type="radio" id="monthly" name="schedule" value="monthly" > Monthly</label>
	  </div>
	  ...
	  <label class="control-label" style="padding:0px;" for="sel1">Spammer Check:</label>
	   ...
	   <BR>
	  To prevent automated spam bots using this form, please enter the following string of letters and numbers into the field above:
	...
	<P style="text-align:left;">After you click Submit, once we have checked all details and confirmed with you, an invoice will be emailed to the above address with a click to pay button for you to easily create the weekly or monthly 
	subscription payment via PayPal. You will easily be able to cancel that subscription at any time through your Paypal account.</p>
</div>
